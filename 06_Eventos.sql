...
DO
BEGIN
	INSERT INTO ranking_productos (nombre_producto, posicion, unidades_vendidas)
	SELECT nombre, posicion, unidades_vendidas 
	FROM (
	    SELECT P.nombre,
...
DO
BEGIN
	INSERT INTO reportes_proveedores (nombre_proveedor, anio, mes, unidades_vendidas, monto_generado)
	SELECT PR.nombre,
